...
```bash
python3 scripts/fetch_datasets.py owid_co2
```

This downloads `owid-co2-data.csv` (~50,000 rows, CC BY 4.0) into `data/owid_co2/`.
...
Open Claude Code in the ds-crew directory (or any directory with the downloaded data)
and run:

```
/ds-star-plus

Dataset: data/owid_co2/owid-co2-data.csv
