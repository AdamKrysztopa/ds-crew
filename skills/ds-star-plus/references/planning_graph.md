...
**Grounding.** This pattern is taken from **Data Interpreter** (Hong et al. / MetaGPT team, 2024,
arXiv:[2402.18679](https://arxiv.org/abs/2402.18679)), whose hierarchical DAG plan rewrites
individual nodes on execution feedback. The key idea adopted here is *mid-task plan repair of the
affected subtree* rather than full replanning when a step fails.
